        ...
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="rounded-xl p-8 border-white/10 border hover:-translate-y-1 transition-all">
            <p className="text-gray-300 mb-6">
              A developer who is always ready and willing to learn and hone new
              skills.
            </p>
            ...
            <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition all">
              ...
              <ul className="list-inside list-disc text-gray-300 space-y-2">
                <li className="list-none">
                  <a
                    href="https://siebelschool.illinois.edu/academics/undergraduate/degree-program-options/cs-x-degree-programs/computer-science-linguistics"
                ...
                <li>Cumulative GPA: 3.80</li>
                <li className="text-sm">
                  Relevant coursework: Applied Machine Learning, Algorithms and
                  Models of Computation, Systems Programming, Data Structures,
                  Computer Architecture, Discrete Structures, Elements of
                  Syntax, Elements Semantics & Pragmatics...
                </li>
              ...
              <div className="space-y-4 text-gray-300">
                <div>
                  <ul className="list-inside text-gray-300 space-y-2">
                    <li className="list-none">
                      <a
                        href="https://namu.wiki/w/%EC%A0%95%EB%B3%B4%ED%86%B5%EC%8B%A0#s-4.1.5"
                        className="inline-flex items-center font-bold hover:text-blue-400"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                      ...
                      <br></br>Capital Defense Command, ROKA (Nov 2022 - May
                      2024)
                    </li>
                    <li className="text-sm">
                  ...
                  <ul className="list-inside text-gray-300 space-y-2 pt-4">
                    ...
                    <li className="text-sm">
                      ...
                      ventilated patients in Seoul National University Hospital
                      in order to develop an offline reinforcement learning
                      algorithm to assist clinicians with manual mechanical
                      ventilator control.
                    </li>
                  </ul>
                </div>
