...
export const Contact = () => {
    ...
    const SERVICE_ID = "service_adaftvu";
    const TEMPLATE_ID = "template_mtefmlq";
    const PUBLIC_KEY = "eJFkfqGrRpH4xvoub";
                ...
                <div className="px4 w-150">
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        className="w-full bg-blue-500 text-white py-3 px-6 rounded font-medium transition relative 
                            overflow-hidden hover:translate-y-0.5 hover:shadow-[0_0_15px_rgba(59, 13, 246, 0.4)]">
                                Send Message
                        </button>
                    </form>
                </div>
