      ...
      <RevealOnScroll>
        <div className="text-center z-10 px-4">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-500 to-cyan-600 bg-clip-text  text-transparent leading-right">
            Hi, my name is Junehyuk Yoo
          </h1>

          <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
            I&apos;m an aspiring software engineer who loves learning new skills
            and building new products. My goal is to continue my professional
            development and tackle real-world problems with the power of
            computer science.
          </p>
